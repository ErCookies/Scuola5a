...
Il *conflitto* fa esplodere contraddizioni e divisioni già esistenti e diffonde *sfiducia* nei confronti della *classe dirigente*.
...
I vecchi *partiti politici liberali* si dimostrano *incapaci* di rappresentare le istanze delle forze sociali, aprendo la strada a due *partiti di massa*: **socialisti e popolari**.

Nel 1919 nasce, per iniziativa di *Don Sturzo*, il ***Partito popolare*** (di ispirazione cattolica --> superamento definitivo del "Non-Expedit")

Appoggiato dalla *CIL* (*C*onfederazione *I*taliana del *L*avoro) con un programma democratico:
...
(I POPOLARI ERANO PIÙ DEBOLI AL SUD PER VIA DEI LIBERALI CHE PRENDEVANO I VOTI TRAMITE LE CLIENTELE)
...
Nel 1919 *Mussolini* - attraverso il suo giornale "Il popolo d'Italia" organizza a Milano i ***Fasci di combattimento*** raccogliendo *nazionalisti, ex-combattenti* (senza partito), *sindacalisti rivoluzionari* e giovani borghesi con un programma molto eterogeneo che unisce un forte *nazionalismo* a rivendicazioni democratiche ed *anticapitaliste*.



Nonostante la presenza di diverse anime, il Fascismo si caratterizza fin dall'inizio per l'esaltazione dell'*azione individuale* della *violenza*.

L'*antiparlamentarismo* e l'*antisocialismo*, di cui delle prime manifestazioni è la *distruzione della sede dell'**Avanti*** a Milano.

L'*opinione pubblica* e i *partiti politici* non colgono la portata del fenomeno fascista considerandolo un *movimento passeggero* destinato ad essere riassorbito.
...
Oltre alle *difficoltà economiche* ed ai *contrasti sociali*, l'Italia deve fronteggiare la *frustrazione* per l'esito della guerra (si parla di *Vittoria mutilata*). Le *richieste italiane* (Patto di Londra + Fiume) vengono *respinte* dagli alleati -- SOPRATUTTO DA *WILSON*.

*D'Annunzio* nel settembre 1919 con volontari e soldati *occupa **Fiume*** e instaura un *governo provvisorio*, dichiarando l'annessione all'Italia. Il governo non reagisce adeguatamente.

In questo clima incerto si svolgono le *elezioni del 1919* con il proporzionale che vedono una *sconfitta dei liberali* ed una *vittoria di socialisti e popolari*.
